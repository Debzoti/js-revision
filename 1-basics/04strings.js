...
const txt  = "    lol   "
console.log(txt.trim());  // trimes only white space characters theres also trimstart() and trimend()

const url = `https://www.google.co.in/`
console.log(url.replace('//','..')); // replaces first arg with second arg in string
console.log(url.split('.',3)); // split with respect to sperator and returns an array of parts next arg is a limit to no of parts you want to store in the array

//checkout all methods on javascript.info
